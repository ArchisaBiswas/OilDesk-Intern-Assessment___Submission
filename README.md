...
5. Each question should be answered in a separate Jupyter Notebook `.ipynb` file.
6. Any packages you use, **MUST** be added to the `pyproject.toml` file 
    - Your code must be runnable after running the command `uv sync`


8. Push the completed Notebook back to your GitHub repository.
9. Share the GitHub link with us, by the deadline provided.
...
- Make your code as efficient (vectorized) as possible.
